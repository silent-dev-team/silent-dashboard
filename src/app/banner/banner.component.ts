...
export class BannerComponent implements OnInit,AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    //reset on resize with resize observer
    var resizeObserver = new ResizeObserver(()=>this.reset());
    resizeObserver.observe(document.body);
    resizeObserver.observe(this.test.nativeElement);
  }
  lastText = -1;
  count = 0;
  ...
  async animateScrollIn(){
    ...
    this.lastOffset = wrapper.offsetWidth;
  }
  animateScrollOut(){
